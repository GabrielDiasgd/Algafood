...
public class RestauranteUsuarioResponsavelController implements RestauranteUsuarioResponsavelControllerOpenApi {
	...
	public CollectionModel<UsuarioModel> listar (@PathVariable Long restauranteId) {
		...
		CollectionModel<UsuarioModel> usuariosModelAssembler = usuarioModelAssembler.toCollectionModel(restaurante.getResponsaveis())
				.removeLinks()
				.add(algaLinks.linkToResponsaveisRestaurante(restauranteId))
				.add(algaLinks.linkToResponsavelRestauranteAssociacao(restauranteId, "associar"));
		
		usuariosModelAssembler.getContent().forEach(usuarioModelAssembler -> {
			usuarioModelAssembler.add(algaLinks.linkToResponsavelRestauranteDesassociacao(restauranteId, usuarioModelAssembler.getId(), "desassociar"));
		});
		
		return usuariosModelAssembler;
	}
