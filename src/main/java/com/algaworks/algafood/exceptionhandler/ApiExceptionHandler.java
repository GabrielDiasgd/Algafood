...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	private static final String MSG_ERRO_GENERICA_USUARIO_FINAL = "Ocorreu um erro interno inesperado no sistema. Tente novamente e se o"
			+ " problema persistir entre em contado com o administrador do sistema.";	
	...
	protected ResponseEntity<Object> handleNoHandlerFoundException(NoHandlerFoundException ex, HttpHeaders headers,
		...
		Problem problem = createProblemBuilder(status, problemType, detail)
				.userMessage(String.format("O recurso %s, que você tentou acessar não existe.", ex.getRequestURL()))
				.build();
	...
	private ResponseEntity<Object> handlePropertyBinding(PropertyBindingException ex, HttpHeaders headers,
		...
		ProblemType problemType = ProblemType.MENSAGEM_IMCOMPREENSIVEL;
		String detail = String.format(
				"A propriedade '%s' não é uma propridade existente na classe %s."
...
//		ex.getPath().forEach(ref -> System.out.println(ref.getFieldName()));
		...
		ProblemType problemType = ProblemType.MENSAGEM_IMCOMPREENSIVEL;
		String detail = String.format(
				"A propriedade '%s' recebeu um valor '%s',"
						+ "que é de um tipo inválido. Corrija e informe um valor compatível com o tipo %s.",
